...
// function visibleAbout()
// {
//     document.getElementById("aboutColoumn").style.display='block';
//     document.getElementById('educationColoumn').style.display='none';
//     document.getElementById('extraCuricularColoumn').style.display='none';
//     document.getElementById('achievementsColoumn').style.display='none';
//     document.getElementById('projectsColoumn').style.display='none';
//     document.getElementById('contactColoumn').style.display='none';
// }
// function visibleEducation()
// {
//     document.getElementById('aboutColoumn').style.display='none';
//     document.getElementById('educationColoumn').style.display='block';
//     document.getElementById('extraCuricularColoumn').style.display='none';
//     document.getElementById('achievementsColoumn').style.display='none';
//     document.getElementById('projectsColoumn').style.display='none';
//     document.getElementById('contactColoumn').style.display='none';
...
//     document.getElementById('aboutColoumn').style.display='none';
//     document.getElementById('educationColoumn').style.display='none';
//     document.getElementById('extraCuricularColoumn').style.display='block';
//     document.getElementById('achievementsColoumn').style.display='none';
//     document.getElementById('projectsColoumn').style.display='none';
//     document.getElementById('contactColoumn').style.display='none';
// }
...
//     document.getElementById('educationColoumn').style.display='none';
//     document.getElementById('extraCuricularColoumn').style.display='none';
//     document.getElementById('achievementsColoumn').style.display='block';
//     document.getElementById('projectsColoumn').style.display='none';
//     document.getElementById('contactColoumn').style.display='none';
// }
// function visibleProject()
...
//     document.getElementById('extraCuricularColoumn').style.display='none';
//     document.getElementById('achievementsColoumn').style.display='none';
//     document.getElementById('projectsColoumn').style.display='block';
//     document.getElementById('contactColoumn').style.display='none';
// }
// function visibleContact()
// {
...
//     document.getElementById('achievementsColoumn').style.display='none';
//     document.getElementById('projectsColoumn').style.display='none';
//     document.getElementById('contactColoumn').style.display='block';
// }
